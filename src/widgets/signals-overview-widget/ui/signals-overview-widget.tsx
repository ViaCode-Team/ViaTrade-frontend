...
import { SignalsControls, useSignalsControls } from '@/features/signal/filter-signals';

import { SignalsOverviewListBoundary } from './signals-overview-list';
import { SignalsStatusBarBoundary } from './signals-status-bar';

export function SignalsOverviewWidget({ onSignalSelect }: { onSignalSelect: (signal: Signal) => void }) {
