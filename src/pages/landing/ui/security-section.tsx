...
const SECURITY_FEATURES = [
	...
	{
		title: 'ПИН-код на устройстве',
		description: 'Защищает доступ к приложению на этом устройстве. ПИН-код потребуется ввести после 15 минут бездействия или через 6 часов.',
		icon: IconShieldLock,
	},
	{
