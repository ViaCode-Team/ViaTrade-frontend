			...
			<Container size='xs' style={{ width: '100%', maxWidth: '400px' }}>
				<Paper p='xl' withBorder style={{ position: 'relative' }}>
					...
					<Title order={2} ta='center' mt={step === 2 ? 'md' : 'xs'} mb='xs'>
						{step === 1 ? 'Создайте ПИН-код' : 'Подтвердите ПИН-код'}
					</Title>

					<Text c='dimmed' size='sm' ta='center' mb='xl'>
						{step === 1
							? 'ПИН-код защищает данные на этом устройстве. Его потребуется ввести после 15 минут бездействия или через 6 часов после последнего ввода.'
							: 'Введите ПИН-код ещё раз для подтверждения.'}
					</Text>
