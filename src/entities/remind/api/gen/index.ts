...
export function getDeleteActualRemindMutationOptions<TError = ErrorType<ProblemDetails>, TContext = unknown>(queryClient: QueryClient, options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteActualRemind>>, TError, { remindId: number }, TContext>; skipInvalidation?: boolean; request?: SecondParameter<typeof customInstance> }): UseMutationOptions<Awaited<ReturnType<typeof deleteActualRemind>>, TError, { remindId: number }, TContext> {
	...
	const onSuccess = (data: Awaited<ReturnType<typeof deleteActualRemind>>, variables: { remindId: number }, onMutateResult: TContext, context: MutationFunctionContext) => {
		if (!options?.skipInvalidation) {
			...
			queryClient.invalidateQueries({ queryKey: getGetActualRemindQueryKey() });
			queryClient.invalidateQueries({ queryKey: getGetRemindByIdQueryKey(variables.remindId) });
		}
...
export function useDeleteActualRemind<TError = ErrorType<ProblemDetails>, TContext = unknown>(options?: { mutation?: UseMutationOptions<Awaited<ReturnType<typeof deleteActualRemind>>, TError, { remindId: number }, TContext>; skipInvalidation?: boolean; request?: SecondParameter<typeof customInstance> }, queryClient?: QueryClient): UseMutationResult<
...
> {
	...
	return useMutation(getDeleteActualRemindMutationOptions(queryClient ?? backupQueryClient, options), queryClient);
}
